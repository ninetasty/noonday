...
>개별 아티스트(스타)가 브로드웨이에서 창조적 성공을 결정하는 요소가 아니다. 특정 노래나 화려한 색, 의상 심지어 주제도 아님. 히트작은 쇼 뒤에서 협력하는 팀들 사이의 특별한 동역학에서 나왔다.
...
- 단순한 문제를 푸는 방법은 항상 좋은 해결책이었지만, 가능한 최선의 채결책과는 거리가 멀었다.
